...
public class GraphDBExample {
    ...
    public static void main(String[] args) {
        ...
        String queryString = "PREFIX rat: <http://www.semanticweb.org/30693/ontologies/2022/5/untitled-ontology-26> \n";
        queryString += "SELECT (MAX(?total_ratings) as ?max) ?name(MAX(?total_ratings) as ?max)  \n";
        queryString += "WHERE { \n";
        queryString += "  ?movies rdfs:label ?name.\n" +
